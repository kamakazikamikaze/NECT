...
from nect.helpers import infinite_dd
...
class Device(ConfigItem):
    ...
    """
    def __init__(self, model=None, stack_number=None, port_count=None,
                 ports=None, extension_modules=None, vendor=None,
                 port_naming=None, **kwargs):
    ...
    def __repr__(self):
        metadata = ['stack_number', 'model', 'port_count']
        buildstr = []
...
class Host(ConfigItem):
    ...
    def __init__(self, name='AutoGenerated', devices=None, **kwargs):
        if devices is None:
            devices = WeakList()
        elif not isinstance(devices, WeakList):
            devices = WeakList(devices)
        kwargs.update({'name': name, 'devices': devices})
...
class VLAN(Interface):
    ...
    def __init__(self, number=None, name=None, address=None, mask=None,
                 ports=None, **kwargs):
        kwargs.update(locals())
        del kwargs['self']
        del kwargs['kwargs']
...
class DNS(IP):
    ...
    def __init__(self, domain_name=None, name_servers=None,
                 domain_list=None, **kwargs):
...
class AAA(Auth):
    ...
    def __init__(self, authentication=None, authorization=None,
                 accounting=None, enabled=False):
        if authentication is None:
            authentication = infinite_dd()
        if authorization is None:
            authorization = infinite_dd()
        if accounting is None:
            accounting = infinite_dd()
        kwargs = locals()
        del kwargs['self']
...
class LocalLogging(ConfigItem):
    ...
    def __init__(self, buffer_size=None, filename=None, max_size=None,
...
class LogServer(ConfigItem):
    r"""
    Logging servers and preferences
    """

    def __init__(self, address, names=None, port=None, proto=None):
        kwargs = locals()
        del kwargs['self']
...
class NTPServer(NTP):
    def __init__(self, address, proto=None, **kwargs):
        kwargs.update({'address': address, 'proto': proto})
        super(NTPServer, self).__init__(**kwargs)
